...
import Youtubes from "../Icon/twitter-Photoroom.png";
import Image from "next/image";

import BosttwitterAccount from "../Icon/TwitterAccounts.png";
  ...
  return (
    <div className="youtubePage">
      ...
      <div className="View">
        ...
        <div className="hader">grow your Account with real traffic</div>
      </div>
      <div className="graphics">
        <div className="CoverGraphics">
          <Image src={BosttwitterAccount} alt="Bostchannel" width={500} />
        </div>
