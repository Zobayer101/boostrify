...
import Youtubes from "../Icon/facebook-Photoroom.png";
import Image from "next/image";

import BostChannel from "../Icon/FacebookBoosting.png";
      ...
      <div className="graphics">
        ...
        <div className="AboutText">
          <p className="paragraph">
            ...
            authentic engagement, and watch your channel thrive. It&apos;s fast,
            easy to use, and offers real results to help content creators
            succeed in today’s competitive digital world. Boost your presence
            with confidence and watch your growth skyrocket!
          </p>
        </div>
      </div>
      <Services />
